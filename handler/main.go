...
import (
	...
	Modules "github.com/PanGan21/ethereum-api/modules"
...
func (client ClientHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// Handle each request using module parameter
	switch module {
	case "latest-block":
	...
	case "send-eth":
		...
		hash, err := Modules.TransferEth(*client.Client, t.PrivKey, t.To, t.Amount)
